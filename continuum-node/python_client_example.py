...
class ContinuumClient:
    def __init__(
        self, base_url="http://localhost:8080", token="dev-token-strong-and-secret"
    ):
    ...
    try:
        response = client.chat_completion(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Ciao! Dimmi una cosa interessante in una frase.",
                }
            ],
        )
        ...
        if ws_client.connect():
            ...
            ws_client.send_message(
                ...
                messages=[
                    {
                        "role": "user",
                        "content": "Ciao via WebSocket! Rispondi brevemente.",
                    }
                ],
                temperature=0.7,
            )
