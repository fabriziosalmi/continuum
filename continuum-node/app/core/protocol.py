...
class ContinuumProtocol:
    ...
    @staticmethod
    async def unpack_message_from_stream(
    ...
    def create_auth_response(
        success: bool, message: str = "", user_info: Dict[str, Any] = None
    ) -> bytes:
        """
    ...
    def create_completion_request(
        model: str, messages: list, settings: Dict[str, Any] = None
    ) -> bytes:
        """
    ...
    def create_completion_chunk(content: str, is_final: bool = False) -> bytes:
        ...
        """
        payload = {"content": content, "final": is_final}
